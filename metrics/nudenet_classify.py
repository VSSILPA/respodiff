...
def detect_q16(folder=None, image_paths=None, threshold=0.2):
    from metrics.Q16.clip_classifier.classify.inference_images import main_imagedataset
    predictions=main_imagedataset(input_folder=folder, output_folder=folder)
    return predictions
