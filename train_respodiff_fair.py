...
def main():
    ...
    for step in pbar:
        ...
        with torch.no_grad(): 
            ...
            encoder_hidden_states = model._encode_prompt(target_prompt, device, num_images_per_prompt = args.train_batch_size, do_classifier_free_guidance=True)
