...
def parse_args():
    ...
    parser.add_argument("--start_ddim_steps", type=int, default=0)
    parser.add_argument("--end_ddim_steps", type=int, default=49)
    parser.add_argument("--ddpm_steps", type=int, default=1000)
    parser.add_argument("--lambda_align", type=float, default=1)
    parser.add_argument("--target_guidance_scale", type=int, default=4)
    parser.add_argument("--neutral_guidance_scale", type=int, default=1)
    ...
    parser.add_argument("--c_learning_rate",type=float,default=0.1,help="Initial learning rate (after the potential warmup period) to use.",)
    parser.add_argument("--s_learning_rate",type=float,default=0.1,help="Initial learning rate (after the potential warmup period) to use.",)
    ...
    parser.add_argument('--num_valid_data', type=int, default=10)

    #testing
    parser.add_argument('--gen_eval', action='store_true')
    parser.add_argument('--valid_prompt', type=str, default="")
    parser.add_argument('--template_key', type=str, default="0")
    parser.add_argument('--concept', nargs='+') 
    parser.add_argument('--neutral_concept', default='a person') 
    ...
    parser.add_argument('--evaluation_type', type=str, default="eval", choices=['eval','interpolate','winobias','i2p', 'coco-safe-eval', 'coco-fair-eval', 'composition'])
    parser.add_argument('--image_dir', type=str, default="images")
    parser.add_argument('--prompt_file', type=str, default=None)
    parser.add_argument('--compose', action='store_true')

    # for fid and kid
    parser.add_argument('--coco_fair_eval', action='store_true')
    ...
    parser.add_argument('--use_sd', action='store_true', help="use stable diffusion for generation")
